...
8. **Resolution Rules**: Specify exactly how to determine the outcome (e.g., "Resolved by AP or Reuters reporting X").
9. **Tags**: Assign 1-3 relevant tags. Prioritize these standard tags: ${STANDARD_TAGS.join(', ')}. You may create new tags if necessary but prefer standard ones.
